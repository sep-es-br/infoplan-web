...
export const menulinks = [
  { id: 1, status: checkRoles(environment.allowedRoles.indicadores), name: 'Indicadores', link: '', url: environment.urls.indicadores, icon: 'menu-icone-indicadores.svg', src: 'Indicadores Admin', menuIcon: '', color:'rgb(8 49 127)  ' },
  ...
  { id: 4, status: checkRoles(environment.allowedRoles.projetosEstrategicos), name: 'Projetos Estratégicos', link: '/pages/strategicProjects', url: '', icon: 'menu-icone-openpmo.svg', src: 'OpenPMO', menuIcon:'', color:'#44B39B', subTitle: 'Portfólio Realiza+'},
