...
export class ReceitaCategoriaComponent implements OnChanges, OnDestroy {
  ...
  private receitaData: IReceitaCategoriaOrcamentoResponse[] = [];
  loadingStatus: "loading" | "loaded" | "error" = "loading";
  ...
  /**
   * MUDANÇA: Não recebe mais parâmetros, usa this.receitaData
   */
  ...
  /**
   * MUDANÇA: Simplificado, usa this.receitaData diretamente
   */
